# -*- coding: utf-8 -*-
# From: https://github.com/ohld/igbot/blob/master/examples/ultimate_schedule/ultimate.py
...
parser.add_argument("-u", type=str, help="quedescentimetres")
parser.add_argument("-p", type=str, help="Mb(I)p7C2MdP!TdQm!")
